...
check.MouseButton1Click:Connect(function()
    if input.Text == correctKey then
        ...
        wait(1)
        gui:Destroy()
        -- LOAD THE MAIN SCRIPT FROM THE URL (defined below)
...
-- ✅ URL DIPINDAHKAN KE PALING BAWAH
_G.scriptURL = "https://raw.githubusercontent.com/ditzzdsgstd-dotcom/Speed/main/exe.lua"
